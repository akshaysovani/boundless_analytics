...
class Fanalyzer(object):
	...
	def __init__(self, db):
		...
		self.outfile = "".join((self.dbName, '_charts.json'))  # output chart objects file
...
def main():
	# itemsets = []
	# itemsets.append(Itemset([1, 4], 100))
	# itemsets.append(Itemset([0, 4], 100))
	# itemsets.append(Itemset([2, 3, 1], 200))
	# itemsets.append(Itemset([1, 3], 100))
	...
	# virtually join the tables
	db.virtualJoin()
	
	# prepare for ALPINE on the joint table
	db.jointItemRecode(minsup)
	
	# run ALPINE on the joint table
	fa.runAlpine('joined')
	
	# fa.genChartObjs([], xrange(3921), 'Players')
	# fa.genChartObjs([], xrange(24624), 'SeasonsStats')
	# print 'Example 1: '
	# fa.genChartObjsAcrossTables([], xrange(24624))
	# print 'Example 2: '
	# fa.genChartObjsAcrossTables([('birth_state', 'New York')], xrange(24624))
	# fa.chartObject([], xrange(24624), 'Pos', 'birth_state', 1.0)
	# fa.chartObject([], xrange(24624), 'height', 'PTS', 1.0)
	# fa.chartObject([], xrange(24624), 'Pos', 'height', 1.0)
	# fa.chartObject([], xrange(24624), 'height', 'Pos', 1.0)
