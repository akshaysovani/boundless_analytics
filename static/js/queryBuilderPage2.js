...
var dateOfMaxValueInPlotZero = 0;
...
function addTimeSeriesPlot(data, metadata, slice, slice_size_for_this_slice){
    ...
    console.log(dateOfMaxValueInPlotZero);
    console.log(dateOfMaxValueInPlotOne);
    var daysDiff = Math.abs(parseInt((dateOfMaxValueInPlotOne-dateOfMaxValueInPlotZero)/(24*3600*1000)));
    ...
    Highcharts.stockChart('chartForScoreDiv', {
        ...
        xAxis: {
            ...
            plotLines: [{
                color: '#FF0000',
                width: 2,
                value: dateOfMaxValueInPlotZero
            }]
        },
        yAxis: {
            title: {
...
function addTimeSeriesPlotZero(isOrig, slice){
    ...
    var localmaxy = -100000;
    newbiglist.forEach(function(point){
        if (point[1] > localmaxy){
            localmaxy = point[1];
            dateOfMaxValueInPlotZero = point[0];
        }
    });
